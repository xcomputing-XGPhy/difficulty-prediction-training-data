...
def get_rfdist_clusters(log_path, all_trees):
    ...
    # For IQ-Tree, we need to parse the RF distance results differently
    # This is a placeholder - you may need to adjust based on IQ-Tree output format
    for line in content:
        line = line.strip()
...
def filter_tree_topologies(
    ...
    if num_trees > 1:
        ...
        num_topos, _, _ = get_iqtree_rfdist_results(log_path)
